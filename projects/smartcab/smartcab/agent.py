...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        #state = ('is_raining', 'is_foggy', 'is_red_light', 'turn_left', 'no_traffic', 'previous_turn_left', 'time_of_day')
    ...
    def createQ(self, state):
        ...
        if self.learning:
        	if state not in self.Q:
        		self.Q.setdefault(state,dict(zip(self.valid_actions,[0.0]*len(self.valid_actions))))
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            # weights = [self.epsilon]*len(self.valid_actions)
            # print('this is the state', self.state)
            # print('this is the Q', self.Q)
    ...
    def update(self):
        """ The update function is called when a time step is completed in the 
            environment for a given tria
            l. This function will build the agent
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True,alpha=1,epsilon=0.99)
